  ...
  return (
    <div className="courses-body">
      <div style={{display:"flex",alignItems:"center",justifyContent:"center",minHeight:"100vh",padding:20}}>
        <div style={{background:"rgba(20,16,36,.6)",border:"1px solid rgba(255,255,255,.05)",borderRadius:20,padding:30,maxWidth:550,width:"100%"}}>
          <h2 style={{color:"#e2c275",fontSize:20,marginBottom:20,textAlign:"center"}}>🏦 شراء الكورس عبر انستاباي</h2>
          ...
          <div style={{background:"linear-gradient(135deg,rgba(169,52,253,.15),rgba(253,145,219,.1))",border:"1px solid rgba(169,52,253,.2)",borderRadius:14,padding:16,marginBottom:24}}>
            <p style={{color:"#c084fc",fontSize:13,fontWeight:700,marginBottom:6}}>🏦 بيانات الدفع عبر انستاباي:</p>
            <p style={{color:"#9a95b0",fontSize:14}}>يرجى تحويل المبلغ إلى أحد الحسابات التالية ثم رفع صورة التحويل:</p>
            {gateways.length > 0 ? gateways.map((g, i) => (
              ...
              <div style={{textAlign:"center",padding:20}}>
                ...
                <p style={{color:"#9a95b0",fontSize:13,marginTop:4}}>لم يتم إضافة وسيلة دفع انستاباي بعد. يرجى التواصل مع الإدارة.</p>
              </div>
            )}
          </div>
